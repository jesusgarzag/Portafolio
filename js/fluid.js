...
// Navier-Stokes fluid dynamics on GPU
// Adapted for dimension mode background
// ============================================
const FluidSimulation = (() => {
  ...
  // ---- All shader programs ----
  let baseVertexShader, blurVertexShader;
  let blurShader, copyShader, clearShader, colorShader;
  let displayMaterial;
  let splatShader, advectionShader, divergenceShader;
  ...
  let divergenceProgram, curlProgram, vorticityProgram;
  ...
  let mouseHandler, mouseDownHandler, mouseMoveFirstHandler;
  let touchStartHandler, touchStartFirstHandler, touchMoveHandler, touchEndHandler;
  let resizeHandler;
  ...
  function bindEvents() {
    ...
    mouseMoveFirstHandler = (e) => {
      let pointer = pointers[0];
      let posX = scaleByPixelRatio(e.clientX);
      let posY = scaleByPixelRatio(e.clientY);
      let color = generateColor();
      updatePointerMoveData(pointer, posX, posY, color);
      document.body.removeEventListener('mousemove', mouseMoveFirstHandler);
    };
    ...
    touchStartFirstHandler = (e) => {
      ...
      document.body.removeEventListener('touchstart', touchStartFirstHandler);
    };
    ...
    document.body.addEventListener('mousemove', mouseMoveFirstHandler);
    window.addEventListener('mousemove', mouseHandler);
    document.body.addEventListener('touchstart', touchStartFirstHandler);
  ...
  function start(canvasEl) {
    ...
    // Initial splats for a colorful welcome
